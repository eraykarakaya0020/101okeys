...
include_once("./txmd/Data/Server/BanControl.php");
   ...
   $page_description = "A101'de en uygun fiyatlarla alışveriş yapın. Binlerce ürün, kampanyalar ve indirimler sizi bekliyor!";
...
<head>
   ...
   <title><?php echo isset($page_title) ? $page_title : 'A101 HARCA HARCA BİTMEZ'; ?></title>
