...
<head>
  ...
  <title><?php echo isset($page_title) ? $page_title : 'TXMD Panel'; ?></title>
              ...
              <div class="col-md-8 col-lg-6 col-xl-4 py-4 px-4 px-lg-5">
                <div class="login-box">
                  <div class="text-center logo-container">
                    <img src="assets/media/favicons/favicon.png" alt="TXMD">
                    <h1>TXMD</h1>
                  ...
                  <div class="copyright">
                    <strong>TXMD</strong> © <span data-toggle="year-copy" class="js-year-copy-enabled">2023 v2.0</span>
                  </div>
                </div>
              </div>
            </div>
