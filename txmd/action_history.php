...
include_once("./function/MainFunction.php");
include_once("./Data/Client/GetBank.php");
giris_dogrulama($pdo);
...
$userSQL = $pdo->query("SELECT COUNT(*) FROM admin");
$user_sayisi = $userSQL->fetchColumn();
...
<head>
  ...
  <title>monke - İşlem Geçmişi</title>
        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <?php if ($QueryAdmin['yetki'] == "Superadmin"): ?>
              ...
              <li class="nav-main-item">
                <a class="nav-main-link active" href="action_history">
        ...
        <div class="content content-full">
          <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
              <h1 class="h3 fw-bold mb-2"> İşlem Geçmişi </h1>
              <h2 class="fs-base lh-base fw-medium text-muted mb-0">
                <?php echo $mesaj; ?> <a class="link-fx" href="javascript:void(0)"><?php echo $QueryAdmin['kullanici_adi']; ?></a>, bu sayfa sayesinde paneldeki kullanıcıların hangi işlemi yaptığını görebilirsin.
              </h2>
            </div>
            <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item" aria-current="page"> İşlem Geçmişi </li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div class="block block-rounded">
          <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-responsive">
              <thead>
                <tr>
                  <th class="text-center fw-light fs-sm"><i class="fa-regular fa-id-card"></i> ID</th>
                  <th class="text-center fw-light fs-sm"><i class="fa-regular fa-user"></i> KULLANICI ADI</th>
                  <th class="text-center fw-light fs-sm"><i class="fa-solid fa-ranking-star"></i> YETKİ</th>
                  <th class="text-center fw-light fs-sm"><i class="fa-regular fa-compass"></i> IP ADRESI</th>
                  <th class="text-center fw-light fs-sm"><i class="fa-solid fa-list"></i> SON İŞLEM</th>
                </tr>
              </thead>
              <tbody>
                <?php foreach ($pdo->query('SELECT * FROM action_history') as $yazdir) { ?>
                  <tr>
                    ...
                    <td class="text-center fw-normal fs-sm"><?php echo htmlspecialchars($yazdir['son_islem']); ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
  ...
  <script type="text/javascript">
    ...
    clipboard.on('success', function(e) {
      One.helpers('jq-notify', {
        ...
        message: 'Panoya kopyalama işlemi başarılı!'
      });
    });
    ...
    clipboard.on('error', function(e) {
      One.helpers('jq-notify', {
        ...
        message: 'Panoya kopyalama işlemi başarısız!'
      });
    });
